...
var RedbrickCommittee = function RedbrickCommittee() {
  ...
  var showComitteeInfo = function(client, message, cmdArgs) {
    ...
    // Show admins
    var admins = _.find(committee, { role: 'System Administrators' });
