...
var Game = function Game(channel, client, config, challenger, challenged, lettersTime, numbersTime, conundrumsTime ) {
  ...
  console.log('letters: ' + self.letterTime + ' numbers: ' + self.numberTime + ' conundrum: ' + self.conundrumTime);
  ...
  self.stop = function (player, gameEnded) {
    ...
    if (self.round > 1 && gameEnded !== true) {
      self.say(self.challenged.nick + ' has ' + self.challenged.points + ' points while ' + self.challenger.nick +
  ...
  self.numberRoundEnd = function () {
    ...
    if (challenged_difference > 10 && challenger_difference > 10) {
      ...
      if (self.answers.challenger.value === self.table.target && self.answers.challenged.value === self.table.target) {
